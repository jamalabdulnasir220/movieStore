...
// Inngest function to send a confirmation email when a user books a show
const sendConfirmationEmail = inngest.createFunction(
  ...
  async ({ event, step }) => {
    ...
    await sendEmail({
      ...
      <p>Enjoy the show! 🍿</p>
      <p>Thanks for booking with us! <br />- movieStore Team</p>
      </div>`,
    });
  }
);
...
const sendShowReminders = inngest.createFunction(
  ...
  async ({ step }) => {
    ...
    const results = await step.run("send-all-reminders", async () => {
      ...
      <p>Enjoy the show!<br />Showqueue Team</p>
